    ...
    <div>
      <div className="pt-2 w-fit">
        <div className="text-xs text-white/90 backdrop-blur-md bg-black/60 rounded-lg py-2 px-4 flex items-center justify-center gap-4">
          ...
          >
            <span className="text-[11px] leading-none">{t("queue.showHide")}</span>
          ...
          >
            ...
            >
              <span className="text-[11px] leading-none">{t("queue.debug")}</span>
                  <div className="flex gap-1">
                    <button className="bg-white/10 rounded-md px-1.5 py-1 text-[11px] leading-none text-white/70">
                      {COMMAND_KEY}
                    </button>
      ...
      >
        <span className="text-[11px] leading-none">{t("queue.startOver")}</span>
            <div className="flex gap-1">
              <button className="bg-white/10 rounded-md px-1.5 py-1 text-[11px] leading-none text-white/70">
                {COMMAND_KEY}
              </button>
                ...
                <div className="p-3 text-xs bg-black/80 backdrop-blur-md rounded-lg border border-white/10 text-white/90 shadow-lg">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      {!isProcessing && (
                        <>
                          ...
                          >
                            ...
                            <p className="text-[10px] leading-relaxed text-white/70 truncate mt-1">
                              {t("queue.debugScreenshotDescription")}
                            </p>
                          </div>
                          ...
                          {extraScreenshots.length > 0 && (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <span className="truncate">{t("queue.debug")}</span>
                                <div className="flex gap-1 flex-shrink-0">
                                  <span className="bg-white/20 px-1.5 py-0.5 rounded text-[10px] leading-none">
                                    {COMMAND_KEY}
                                  </span>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <span className="truncate">{t("queue.startOver")}</span>
                          <div className="flex gap-1 flex-shrink-0">
                            <span className="bg-white/20 px-1.5 py-0.5 rounded text-[10px] leading-none">
                              {COMMAND_KEY}
                            </span>
