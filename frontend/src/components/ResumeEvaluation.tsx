...
import { Progress, Typography, Tag, Empty, Spin, Collapse, Card, Grid } from 'antd';
import { 
  CheckCircleFilled, 
  WarningFilled, 
  CloseCircleFilled,
...
export const ResumeEvaluation: React.FC<ResumeEvaluationProps> = ({
  loading,
  result,
}) => {
  const screens = useBreakpoint();
  const isMobile = !screens.md; // mobile if less than md (768px)
  ...
  return (
    ...
    >
      <div style={{ borderRadius: 20, overflow: 'hidden' }}>
              ...
              <Progress
                ...
                format={(percent) => (
                  <div style={{ lineHeight: 1.1 }}>
                    <div style={{ fontSize: isMobile ? 32 : 36, fontWeight: 700, color: scoreData.color }}>
                      {percent}
                    </div>
                    <div style={{ fontSize: isMobile ? 12 : 14, color: '#94a3b8', fontWeight: 500 }}>
                      из 100
                    </div>
                  </div>
                )}
        ...
        {/* Remarks section */}
        <div style={{ 
          padding: isMobile ? '24px 20px' : '32px 40px 40px', 
          background: 'white' 
        }}>
            ...
            <>
              ...
              >
                {result.remarks.map((remark, index) => (
                  ...
                  >
                    <div style={{ paddingLeft: isMobile ? 0 : 44 }}>
                      <Text style={{ 
                        display: 'block',
                        color: '#475569',
                        fontSize: 14,
